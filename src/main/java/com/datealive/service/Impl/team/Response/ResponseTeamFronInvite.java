...
/**
 * @ClassName: ResponseTeamFronInvite
 * @Description: TODO
 * @author: datealive
 * @date: 2021/5/17  19:23
 */
@Service
public class ResponseTeamFronInvite extends ResponseTeamTemplate{
        ...
        if (resopnseTeamDto.getIsAgree().equals(1)) {
            ...
            if (redisUtil.hHasKey(StaticFinalCode.Captain_INVITE_Key,
                ...
                if (teammateService.joinInTeam(teammate)) {
                    redisService.hdelKeyAndItem(StaticFinalCode.Captain_INVITE_Key,
                            resopnseTeamDto.getRateID()+":"+ resopnseTeamDto.getTeamID()+":"+ resopnseTeamDto.getUserID());
                    redisService.hdelKeyAndItem(StaticFinalCode.User_INVITE_MESSAGE_Key+":"+resopnseTeamDto.getUserID(),
                            resopnseTeamDto.getRateID()+":"+ resopnseTeamDto.getTeamID()+":"+ resopnseTeamDto.getUserID());
                }
            }
            return;
